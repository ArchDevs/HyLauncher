...
export function BrowseGameDirectory() {
  return window['go']['app']['App']['BrowseGameDirectory']();
}
...
export function GetGameDirectory() {
  return window['go']['app']['App']['GetGameDirectory']();
}
...
export function SetGameDirectory(arg1) {
  return window['go']['app']['App']['SetGameDirectory'](arg1);
}
